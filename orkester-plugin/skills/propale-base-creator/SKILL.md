...
La structure découle de quatre axes. Récupérer leur valeur dans la demande de l'utilisateur ; pour ce qui manque, **poser des questions courtes et groupées** (ne pas lancer la trame sur des hypothèses silencieuses, car l'axe 1 et l'axe 4 changent radicalement le résultat).
