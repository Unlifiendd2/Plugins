...
description: >
  ...
  output/tmp/_revue-pertinence-[nom-projet].md et retourne uniquement une confirmation avec le
...
Fichier produit : [chemin absolu du fichier output/tmp/_revue-pertinence-[nom-projet].md]
```
