...
description: >
  ...
  output/tmp/_revue-storytelling-[nom-projet].md et retourne uniquement une confirmation avec
...
Fichier produit : [chemin absolu du fichier output/tmp/_revue-storytelling-[nom-projet].md]
```
