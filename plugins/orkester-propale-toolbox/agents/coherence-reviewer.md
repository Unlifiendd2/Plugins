...
description: >
  ...
  écrit son analyse dans un fichier temporaire output/tmp/_revue-coherence-[nom-projet].md et
  retourne uniquement une confirmation avec le chemin du fichier produit. Lancé en parallèle
...
Fichier produit : [chemin absolu du fichier output/tmp/_revue-coherence-[nom-projet].md]
```
